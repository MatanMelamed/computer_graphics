...
public class WwavefrontObjectLoader_DisplayList {
    ...
    public WwavefrontObjectLoader_DisplayList(String inModelPath) {
    ...
    public static int loadWavefrontObjectAsDisplayList(GL2 inGL,String inFileName) {
        ...
        WwavefrontObjectLoader_DisplayList tWaveFrontObjectModel = new WwavefrontObjectLoader_DisplayList(inFileName);

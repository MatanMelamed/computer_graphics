...
import com.matan.studies.computergraphics.GameObjects.Components.MaterialComponent;
...
import com.matan.studies.computergraphics.GameObjects.Prefabs.BoxObject;
import com.matan.studies.computergraphics.GameObjects.Prefabs.PlateObject;
...
//        CreateAxisMarkers();
    ...
    GameObject GenerateMaze(float w, float g, float h) {
        ...
        boxObject = new BoxObject("inside wall", w, h, 3f * u, "concc.jpg");
        boxObject.Move(0.5f * u, h / 2f, -u + (w / 2f));
        maze.AddChild(boxObject);

        boxObject = new BoxObject("inside wall", w, h, 1f * u, "concc.jpg");
        boxObject.Move(-1.5f * u, h / 2f, -u - g - w / 2f);
        maze.AddChild(boxObject);
        ...
        boxObject = new BoxObject("inside wall", w, h, 1f * u, "concc.jpg");
        boxObject.Move(0.5f * u, h / 2f, +u + g + w / 2f);
        maze.AddChild(boxObject);

        boxObject = new BoxObject("inside wall", w, h, 1f * u, "concc.jpg");
        boxObject.Move(1.5f * u, h / 2f, g + w / 2f);
        maze.AddChild(boxObject);
        ...
        boxObject = new BoxObject("inside wall", w, h, 1f * u, "concc.jpg");
        boxObject.Move(-0.5f * u, h / 2f, u / 2f + g / 2f + w);
        maze.AddChild(boxObject);
        ...
        boxObject.Move(1f * u + w / 2f, h / 2f, 1.5f * u);
        maze.AddChild(boxObject);

        boxObject = new BoxObject("inside wall", 1f * u, h, w, "concc.jpg");
        boxObject.Move(u + w / 2f, h / 2f, -1.5f * u);
        maze.AddChild(boxObject);

        boxObject = new BoxObject("inside wall", 2f * u, h, w, "concc.jpg");
        boxObject.Move(-u - g / 2f, h / 2f, -0.5f * u);
        maze.AddChild(boxObject);

        boxObject = new BoxObject("inside wall", 2f * u, h, w, "concc.jpg");
        boxObject.Move(-g / 2f - w, h / 2f, 0.5f * u);
        maze.AddChild(boxObject);
    ...
    GameObject GetDecorations(float w, float g, float h) {
        ...
        picture.Move(5.9000f, 1.2000f, 0f);
